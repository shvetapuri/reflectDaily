//
//  iReflectEditQuoteViewController.m
//  iReflect
//
...
@interface iReflectEditQuoteViewController ()

@end

@implementation iReflectEditQuoteViewController
...
- (BOOL)textViewShouldReturn:(UITextView *)textView {
    if ((textView == self.quoteInput) || (textView == self.authorInput)) {
